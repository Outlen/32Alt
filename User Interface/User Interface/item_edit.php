...
if ($proid === "admin" && $propass === "Pa55w.rd" || $type == "Manager" && $id == $proid && $pass == $propass) 
    { echo"
    <form method='post' action='item_edit_config.php'
        <fieldset>
        <legend><strong>Old Item Details</strong></legend>
        <p><label for='oldsku'>Item Stock Keeping Unit: </label>
        <input type='text' name='oldsku' id='oldsku' pattern='[0-9]+' maxlength='11' required/></p>
        <p><label for='olditemname'>Item Name: </label>
        <input type='text' name='olditemname' id='olditemname' maxlength='100' required/></p>
        <p><label for='olditemprice'>Item Price (AUD): </label>
        <input type='text' name='olditemprice' id='olditemprice' maxlength='11' required/></p>
        <p><label for='olditemquantity'>Item Quantity: </label>
        <input type='text' name='olditemquantity' id='olditemquantity' pattern='[0-9]+' maxlength='11' required/></p>
        <p><label for='olddate' required>Item Expiry oldDate: </label>
        <input type='date' name='olddate' id='olddate'required/></p>
        <p><label for='olditemc'>Item Category: </label>
        <input type='text' name='olditemc' id='olditemc' maxlength='20' required/></p>
        <p><label for='olditemmonthlysupply'>Item Monthly Supplier Purchases: </label>
        <input type='text' name='olditemmonthlysupply' id='olditemmonthlysupply' pattern='[0-9]+' maxlength='11' required/></p>
        </fieldset>
