...
<hr> 
<h2>GotoGrow-MRM Sales Management - E Sale</h2>
...
if ($proid === "admin" && $propass === "Pa55w.rd" || $type == "Manager" && $id == $proid && $pass == $propass) 
    { echo"
    <form method='post' action='sales_edit_conf.php'
        <fieldset>
            <legend><strong>Old Sale Details</strong></legend>
            <p><label for='oldsid'>Sale ID:</label>
            <input type='text' name='oldsid' id='oldsid' pattern='[0-9]+' maxlength='11' required/></p>
            <p><label for='oldcusid'>Customer ID:</label>
            <input type='text' name='oldcusid' id='oldcusid' pattern='[0-9]+' maxlength='11' required/></p>
            <p><label for='oldisku'>Item Stock Keeping Unit:</label>
            <input type='text' name='oldisku' id='oldisku' pattern='[0-9]+' maxlength='11' required/></p>
            <p><label for='oldiquan'>Item Quantity:</label>
            <input type='text' name='oldiquan' id='oldiquan' pattern='[0-9]+' maxlength='11' required/></p>
            <p><label for='olddate'>Date:</label>
            <input type='date' name='olddate' id='olddate' required/></p>
        </fieldset>
        <fieldset>
            <legend><strong>New Sale Details</strong></legend>
